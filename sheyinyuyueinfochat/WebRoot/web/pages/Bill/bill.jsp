        ...
        columns: [
            [
                //{field: 'ck', checkbox: true},
                        ...
                        {title: '健身房', width: 300, field: 'shop', sortable: true},
                        ...
                        {title: '用户电话', width: 50, field: 'tel',sortable: true},
                        {title: '到场日期', width: 100, field: 'todate',sortable: true},

                        {title: '支付状态', width: 100, field: 'statecn',sortable: true},
           ...
           /*  {
            ...
            '-',
            {
                ...
                handler: function () {
                    ...
                    if (selected) {
                        $.post("<%=__APP__%>/Bill!jiaohao",{bid:selected.id,statecn:"已付款"},function(){
                        	closeFlush();
                        });
                    } else {
