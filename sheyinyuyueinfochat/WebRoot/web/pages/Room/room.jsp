    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '桌号', width: 100, field: 'title', sortable: true},
                {title: '说明', width: 400, field: 'note',sortable: true},
                {title: '状态', width: 400, field: 'state',sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
<div id="managerDialog" class="easyui-dialog" title="桌号管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                ...
                <td width="60%" colspan="1">
                    <select id="state" name="room.state">
            ...
            <tr>
                ...
                <td colspan="1" width="60%">
                    <textarea style="width:300px;height: 100px;" id="note" name="room.note"></textarea>
                </td>
            </tr>
        </table>
