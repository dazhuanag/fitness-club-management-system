    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '所属健身房', width: 100, field: 'shop', sortable: true},
                {title: '分类', width: 100, field: 'type', sortable: true},
...
<div id="managerDialog" class="easyui-dialog" title="器材设施管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="type" name="good.type"/>
<!--         <input id="sid" name="good.sid" value="1" type="hidden" style="width:200px;word-wrap: break-word;word-break:break-all;" />
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
			...
			<tr>
                <th width="30%" align="right"><label>所属健身房：</label></th>
                <td width="30%">
                ...
                <th width="30%" align="right"><label>分配教练：</label></th>
                <td width="30%">
                    <input id="uid" name="good.uid" style="width:200px;word-wrap: break-word;word-break:break-all;" />
                </td>
            </tr>
