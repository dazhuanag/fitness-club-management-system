...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
{"menuid": "1", "icon": "icon-magic", "menuname": "健身房管理",
          "menus": [
              {"menuid": "12", "menuname": "健身房列表", "icon": "icon-database", "url": "<%= __APP__%>/Shop!shop"}
          ]},
 
          {"menuid": "1", "icon": "icon-magic", "menuname": "论坛管理",
	                 "menus": [
	                     {"menuid": "12", "menuname": "论坛列表", "icon": "icon-database", "url": "<%= __APP__%>/Posts!posts"}
	                 ]},
	                 /*{"menuid": "1", "icon": "icon-magic", "menuname": "器材设施管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "器材设施列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!good"}
   	                 ]},
   	             ...
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "类别管理",
   	                 ...
   	                 {"menuid": "1", "icon": "icon-magic", "menuname": "健身知识管理",
   	                     "menus": [
                            {"menuid": "12", "menuname": "健身知识列表", "icon": "icon-database", "url": "<%= __APP__%>/Notice!notice"}
   	                     ]},
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "预约管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "预约管理", "icon": "icon-database", "url": "<%= __APP__%>/Bill!bill"}
   	                 ]},
   	             ...
   	             {"menuid": "56", "icon": "icon-role", "menuname": "用户管理",
   	                 "menus": [
   	                  ...
   	                  {"menuid": "32", "menuname": "教练审核", "icon": "icon-users", "url": "<%= __APP__%>/User!user2"}
   	                 ]
