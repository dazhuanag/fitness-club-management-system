    ...
    <script type="text/javascript">
        $(function () {
            $('#grid1').datagrid({
                ...
                striped: true,
                fit: true,
                url: "<%=__APP__%>/User!getList?isjl=1",
                idField: 'uuid',
                pagination: true,
                rownumbers: true,
                pageSize: 10,
                ...
                columns: [
                    [
                        ...
                        {title: '健身房', width: 100, field: 'shop'},
                        {title:'身份证',width:100,field:'idcard'},
                        //{title:'证书',width:100,field:'zhengshu'},
                        {title:'收费',width:100,field:'price'},
                        {title:'可预约时间',width:200,field:'zizhi'},
                        {title:'状态',width:100,field:'statecn'},
                ...
                handler: function () {
                    ...
                    if (selected) {
                    	$.post("<%=__APP__%>/User!userState",{bid:selected.id,statecn:"通过"},function(){
                        	closeFlush();
                        });
                    } else {
                ...
                handler: function () {
                    ...
                    var selected = $('#grid1').datagrid('getSelected');
                    if (selected) {
                        $.post("<%=__APP__%>/User!userState",{bid:selected.id,statecn:"退回"},function(){
                        	closeFlush();
                        });
                    } else {
                        $.messager.alert("提示", "请选择一条记录进行操作");
            ...
            <tr>
                ...
                <td width="30%">
                    <select id="roletype" name="user.roletype" class="easyui-combobox" panelHeight="auto"
                        ...
                        <option value="1" selected="selected">教练</option>
