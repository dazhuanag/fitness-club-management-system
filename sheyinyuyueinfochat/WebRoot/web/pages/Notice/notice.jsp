    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '图片', field: 'img', width: 100, hidden: false,formatter:function(v){
                	return '<img src="'+__APP__+'/upload/'+v+'" style="width:100px;" />'
                }},
...
<div id="managerDialog" class="easyui-dialog" title="健身知识管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
			...
			<tr>
                <th width="30%" align="right"><label>健身知识图片：</label></th>
                <td colspan="" width="30%">
           ...
           <tr>
           	<th width="30%" align="right"><label>所属健身房：</label></th>
                <td width="30%">
                    <input id="sid" name="notice.sid" style="width:200px;word-wrap: break-word;word-break:break-all;" />
                </td>
           </tr>
